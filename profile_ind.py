...
from backend.btc.indicators import compute_ema, compute_rsi, compute_macd, compute_bollinger_bands, compute_atr, compute_vwap, compute_cvd, add_all_indicators
...
def prof():
    ...
    t0 = time.time()
    compute_cvd(df)
    print("compute_cvd took", time.time()-t0)
